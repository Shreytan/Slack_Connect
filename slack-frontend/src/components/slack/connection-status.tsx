...
export function ConnectionStatus({ className }: ConnectionStatusProps) {
  ...
  const handleConnect = async () => {
    ...
    setIsConnected(true);
    setWorkspaceName("CyberSpace Labs");
    setIsConnecting(false);
    
    toast({
      title: "🚀 Connected to Slack!",
      description: "Neural link established. Ready to schedule quantum messages.",
    });
  };
  ...
  const handleDisconnect = () => {
    ...
    toast({
      ...
      description: "Neural link severed. Reconnect to access the matrix.",
      variant: "destructive",
    });
  };
  ...
  return (
    <div className={cn(
      ...
      <div className="absolute bottom-6 left-6 w-1 h-1 bg-gradient-cyber rounded-full floating-orb opacity-40" style={{animationDelay: '2s'}}></div>
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="gradient-text text-lg font-bold">Neural Slack Connection</div>
            ...
            <div className="space-y-3 flex-1">
              <div className="flex items-center gap-3">
                <h3 className={cn(
                  ...
                  isConnected && "gradient-text"
                )}>
                  Quantum Workspace
                </h3>
                {isConnected && <Wifi className="h-4 w-4 text-success animate-pulse" />}
              </div>
              ...
              {isConnected && (
                <div className="grid grid-cols-3 gap-4 mt-4">
                  ...
                  <div className="text-center">
                    <div className="text-lg font-bold text-pink">&lt; 1ms</div>
                    <div className="text-xs text-muted-foreground">Latency</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-cyber">24/7</div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Badge 
              ...
              className={cn(
                ...
                isConnected && "bg-gradient-secondary shadow-glow"
              )}
            >
